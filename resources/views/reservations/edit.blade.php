<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('reservations.update', $reservation) }}" id="reservationForm">
                        ...
                        <!-- カレンダー表示 -->
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-2">新しい予約日を選択してください</label>
                            ...
                            <input type="hidden" name="reservation_date" id="reservation_date" value="{{ old('reservation_date', $reservation->reservation_datetime->format('Y-m-d')) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="hidden" name="reservation_time" id="reservation_time" value="{{ old('reservation_time', $reservation->reservation_datetime->format('H:i')) }}">
                            <x-input-error :messages="$errors->get('reservation_time')" class="mt-2" />
                        </div>

                        <!-- 選択内容の確認 -->
                        <div id="selectedInfo" class="mb-6 p-4 bg-green-50 rounded-lg">
                            <h3 class="text-lg font-medium text-green-900 mb-2">変更後の予約</h3>
                            <p id="selectedDateTime" class="text-green-800"></p>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let selectedDate = reservationDateInput.value;
            let selectedTime = reservationTimeInput.value;
